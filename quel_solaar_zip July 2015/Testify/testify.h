...
extern boolean	testify_network_address_lookup(UnravelAddress *address, char *dns_name); /* look up a DNS address and turn it in to a IP and port. Returns TRUE if sucessfull.*/
